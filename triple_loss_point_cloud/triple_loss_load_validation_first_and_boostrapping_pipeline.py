...
from triple_loss_point_cloud.triple_loss_updated import DockPointNet
...
if __name__ == '__main__':
    ...
    args = arguments(
        ...
        model_save_name="210201_classification_pointcloud_triple_loss_pretrain",
    ...
    for n in range(0, args.fold_num):
        ...
        # training_model, _, _ = load_checkpoint(os.path.join(args.pretrained_model_folder, '{:d}_fold_{:s}_model.pt'.format(n, args.pretrained_model_mode)), training_model)
