...
def process_classification(pdb_folder, GLY_side_chain_folder, interface_count_folder,  node_feature_folder,
                           receptor_graph_folder,  complex_name):
    involve_atom_list = None
    dis_cut_off = 5
    full_decoy_name = complex_name
    ...
    native_pdb_folder =""                    #todo adding the _r_b location
    file_dir=r'/home/fei/Research/Dataset/zdock_decoy/2_decoys_bm4_zd3.0.2_irad/'
    ...
    with open(interface_count_path) as json_file:
        interface_count_dic = json.load(json_file)
    ...
    if len(node_feature_list) != 0:
        ...
        print(target_name +  " has no feature.")
    ...
    torch.save(data, r'/home/fei/Research/processed_all_data/classification/{:s}.pt'.format(full_decoy_name))  #todo modify
...
def read_decoys_and_categories(label_folder, target_names, subset_number):
    ...
    for file in os.listdir(r'/home/fei/Research/processed_all_data/classification/'):
    ...
    for target in target_names:
        ...
        del decoy_name_list, new_decoy_list, previous_decoy_name_list
    del existing_decoy_names

    return decoy_names, labels


def process_classification_patch(fir_dir, complex_names):
...
class PPDocking_large_dataset(Dataset):
    ...
    def process(self):
        ...
        process_classification_patch(self.root, all_complex_names)

        del all_complex_names
