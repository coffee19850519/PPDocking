...
def renumber_residue_number(pdb_path, if_residue, if_atom):
    #if_residue is True, renumber residue number
    #if_atom equals to True, renumber atom number
