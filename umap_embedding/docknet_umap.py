...
def organize_by_correspondence(x_A, x_B, residue_list_A, residue_list_B, decoy_list, correspondence):
    ...
    for sample_idx in range(len(decoy_list)):
        ...
        # toggle this for looking getting one complex edges or more
        # break
...
class DockPointNet(torch.nn.Module):
    ...
    def forward(self, data):
        ...
        # if self.training:
        # anchor_edges, positive_edges, negative_edges

        return anchor_edges, positive_edges, negative_edges, correspondence, decoy_list
