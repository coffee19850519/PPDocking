...
if __name__ == '__main__':
    ...
    args = arguments(
        ...
        savecheckpoints_monitor="val_acc",
        ...
        model_save_name="201026_classification_pointcloud_3layers_maxGlobalPool",
    ...
    for n in range(0, args.fold_num):
        ...
        training_model = DockPointNet(args.num_node_features,1)
        ...
        if args.mode == 'classification':
            ...
            test_loss, all_complex_names, all_decoy_names, all_scores, all_targets, auc, auc_precision_recall = test_classification(
            ...
            print('{:d} fold test_acc: {:.4f}, test_auc:{:.4f}, test_prc:{:.4f}'.format(n,test_loss,auc, auc_precision_recall))
